...
<iframe width="560" height="315" src="https://www.youtube.com/embed/QKHkL_GLy-M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Конспект по добавлению клавиатуры
...
#### Пример бота, который выводит список самых свежих статей со ссылками по-указанному Хабу из [habr.com](https://habr.com/).
